...
function unleashGremlins(ttl, callback) {
  ...
  .gremlin(gremlins.species
    ...
    .canClick(function(element) {
      return document.body.contains(element) && !matchesSelector(element, ".no_wrap") && (matchesSelector(element, "a") || matchesSelector(element, "button") || matchesSelector(element, "img"));
  }))
...
describe('Monkey testing with gremlins professor page', function() {
  ...
  it('it should not raise any error', function() {
    browser.url('/universidad-de-los-andes/ingenieria-de-sistemas/materias/MISO4208');
